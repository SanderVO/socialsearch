...
class AuthorizationsControllerTest < ActionController::TestCase
  ...
  test "should create authorization" do
    assert_difference('Authorization.count') do
      post :create, authorization: { date_created: @authorization.date_created, provider: @authorization.provider, token: @authorization.token }
    end
  ...
  test "should update authorization" do
    patch :update, id: @authorization, authorization: { date_created: @authorization.date_created, provider: @authorization.provider, token: @authorization.token }
    assert_redirected_to authorization_path(assigns(:authorization))
  end
